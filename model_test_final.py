...
checkpoint_file = '/data/trained_models/cascade_rcnn_dconv_c3-c5_r50_fpn_1x_135_classes_annotation/epoch_5.pth' #/data/trained_models/cascade_rcnn_dconv_c3-c5_r50_fpn_1x_135_classes/epoch_15.pth'
...
for img in glob.glob(os.path.join(FINAL_ONLINE_TEST_PATH, '*.pnm')):
        ...
        write_result(name, result, model.CLASSES, out_file=os.path.join(TEST_RESULT_PATH, 'my_test_epch_5_aug.tsv')) # use name instead name1 for hackthon submission
        img_count+=1
        #print(img_count)
